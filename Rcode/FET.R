...
for(i.simu in 1:n.rep.simu){
  ...
  write.csv(result, file = '/tmp/FET/result.csv', quote = F, row.names = F)
}
...
# FNR.mcf.sd.1 = apply(FNR.mcf,2,sd,na.rm=TRUE)
# FNR.q.sd.1 = apply(FNR.q,2,sd,na.rm=TRUE)
# FNR.mid.sd.1 = apply(FNR.mid,2,sd,na.rm=TRUE)
# FNR.Chen.sd.1 = apply(FNR.Chen,2,sd,na.rm=TRUE)
# FNR.Gilbert.sd.1 = apply(FNR.Gilbert,2,sd,na.rm=TRUE)
...
for(i.simu in 1:n.rep.simu){
  ...
  write.csv(result2, file = '/tmp/FET/result2.csv', quote = F, row.names = F)
}
...
# FNR.mcf.sd.2 = apply(FNR.mcf,2,sd,na.rm=TRUE)
# FNR.q.sd.2 = apply(FNR.q,2,sd,na.rm=TRUE)
# FNR.mid.sd.2 = apply(FNR.mid,2,sd,na.rm=TRUE)
# FNR.Chen.sd.2 = apply(FNR.Chen,2,sd,na.rm=TRUE)
# FNR.Gilbert.sd.2 = apply(FNR.Gilbert,2,sd,na.rm=TRUE)
...
p6
### save the plot ####################
pdf("/tmp/FET/fet.pdf",width=8,height=12)
